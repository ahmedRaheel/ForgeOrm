...
{
    private readonly ConcurrentDictionary<string, ForgeSavedQuery> _queries = new(StringComparer.OrdinalIgnoreCase);
    ...
    {
        _queries[name] = new ForgeSavedQuery { Name = name, Factory = factory };
    }
