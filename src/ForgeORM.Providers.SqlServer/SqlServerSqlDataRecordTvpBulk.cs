...
/// <summary>
/// SQL Server high-performance TVP implementation using SqlDataRecord.
/// This is the default ForgeORM SQL Server bulk path.
/// </summary>
    ...
    private sealed class SqlDataRecordRows<T> : IEnumerable<SqlDataRecord>
    {
        ...
        public IEnumerator<SqlDataRecord> GetEnumerator()
        {
            for (var r = 0; r < _rows.Count; r++)
            {
                ...
                {
                    var declaredType = _plan.GetDeclaredType(c);
                    var value = NormalizeValue(_plan.GetValue(entity, c), declaredType);
                    SetRecordValue(record, c, value, declaredType);
                }
