...
namespace ForgeORM.Providers.PostgreSql.Execution;

public sealed class PostgreSqlForgeProviderExecutor : IForgeProviderExecutor
{
    private readonly ForgeDefaultProviderExecutor _inner = new("PostgreSql");
